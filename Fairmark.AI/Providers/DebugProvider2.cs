...
{
    public class DebugProvider2 : Fairmark.Intelligence.ILLMProvider
    {
        public string Name => "Debug provider (2)";

        public IEnumerable<LLMModelInfo> GetAvailableModels()
        {
            Debug.WriteLine("GetAvailableModels called");
            yield return new LLMModelInfo { Name = "debug-model", Description = "Debug LLM Model (fake) (from provider 2)" };
        }
