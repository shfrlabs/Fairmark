...
{
    public class DebugProvider2 : ILLMProvider
    {
        ...
        public string LastUsedModel
        {
            get
            {
                string current = _localSettings.Values["debug2LastModel"] as string;
                return current;
            }
            set
            {
                _localSettings.Values["debug2LastModel"] = value?.Trim();
            }
        }
